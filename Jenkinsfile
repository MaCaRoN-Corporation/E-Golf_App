            ...
            steps {
                script {
                    ...
                    if(VERSION_TYPE == "debug") {
                        ...
                        androidApkUpload googleCredentialsId: 'Google Play Key', apkFilesPattern: 'Application/Releases/beta_versions/*-release.aab', rolloutPercentage: '100', trackName: 'alpha' // alpha/beta/production
                    } else {
                        echo 'Publishing Beta Version ...'
